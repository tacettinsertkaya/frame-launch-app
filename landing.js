(function () {
    ...
    const translations = {
        tr: {
            ...
            hero_lede: 'FrameLaunch, App Store ve Play Store başvuruları için profesyonel ekran görüntüleri tasarlamanın hızlı, ücretsiz ve gizlilik dostu yolu.',
            ...
            footer_copy: '© <span data-current-year>' + new Date().getFullYear() + '</span> FrameLaunch · Tarayıcıda ücretsiz',
        ...
        en: {
            ...
            hero_lede: 'FrameLaunch is the fast, free, and privacy-friendly way to design professional screenshots for App Store and Play Store submissions.',
            ...
            footer_copy: '© <span data-current-year>' + new Date().getFullYear() + '</span> FrameLaunch · Free in browser',
        ...
        de: {
            ...
            hero_lede: 'FrameLaunch ist der schnelle, kostenlose und datenschutzfreundliche Weg, professionelle Screenshots für App Store und Play Store zu gestalten.',
            ...
            footer_copy: '© <span data-current-year>' + new Date().getFullYear() + '</span> FrameLaunch · Kostenlos im Browser',
            footer_editor: 'Editor',
        ...
        fr: {
            ...
            hero_lede: 'FrameLaunch est le moyen rapide, gratuit et respectueux de la vie privée pour concevoir des captures d\'écran professionnelles pour l\'App Store et le Play Store.',
            ...
            footer_copy: '© <span data-current-year>' + new Date().getFullYear() + '</span> FrameLaunch · Gratuit dans le navigateur',
        ...
        es: {
            ...
            hero_lede: 'FrameLaunch es la forma rápida, gratuita y respetuosa con la privacidad de diseñar capturas de pantalla profesionales para App Store y Play Store.',
            ...
            footer_copy: '© <span data-current-year>' + new Date().getFullYear() + '</span> FrameLaunch · Gratis en el navegador',
            footer_editor: 'Editor',
        ...
        ja: {
            ...
            hero_lede: 'FrameLaunchは、App StoreとPlay Storeのプロフェッショナルなスクリーンショットを、高速・無料・プライバシーに配慮して作成できるツールです。',
            ...
            cta_button: 'エディタを開く',
            footer_copy: '© <span data-current-year>' + new Date().getFullYear() + '</span> FrameLaunch · ブラウザで無料',
            footer_editor: 'エディタ',
            footer_features: '機能',
        },
    };
